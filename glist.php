			  ...
			  <?php 
			 	...
			 	$s=1;
			  	while($oku=mysqli_fetch_assoc($listele)){
					echo "<tr><td>$s</td><td>".$oku["blok"]."/".$oku["daire"]."</td><td>".$oku["ad"]."</td><td>".$oku["tel"]."</td><td>".date("d.m.Y", strtotime($oku["tarih"]))."</td><td><a href='guncel.php?id=".$oku["id"]."'><img src='images/update.png' width='15' height='15'></a></td></tr>";
					$s++;
				}
			  	mysqli_close($baglan);
			  ?>
