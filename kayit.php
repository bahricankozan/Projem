    ...
    <tbody>
      ...
      <tr>
        ...
        <td width="762" valign="top">
			<form id="form2" name="form2" method="post" action="kontrol.php?veri=3">
			<table width="733" height="287" border="1" bordercolor="#BB1C00" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
              <td colspan="2" align="center" bgcolor="#BB1C00"><strong>KAYDETME PANELİ</strong></td>
              </tr>
            <tr>
            ...
            <tr>
              <td>AD-SOYAD:</td>
              <td><input type="text" name="ad" id="ad" style="height: 100%;"></td>
            </tr>
            <tr>
              <td>TELEFON:</td>
              <td><input type="text" name="tel" id="tel" style="height: 100%;"></td>
            </tr>
            <tr>
              <td>KAYIT TARİHİ:</td>
              <td><input type="date" name="tarih" id="tarih" value="<?=$tarih?>" style="height: 100%;"></td>
            </tr>
            <tr>
              <td colspan="2" align="center"><input type="submit" name="submit2" id="submit2" value="KAYDET" style="height: 100%; background-color: #BB1C00"; border="3px";></td>
              </tr>
          </tbody>
        </table>
		</form>
