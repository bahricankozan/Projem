...
<!--------------------------------------------------------------------------------------------------------->	
<form name="frm" method="post" action="kontrol.php?veri=15" enctype="multipart/form-data">
<table border="0" width="90%" cellspacing="0" cellpadding="0">
<tr><td align="center"><p>&nbsp;</p>
	<table border="1" width="450" bordercolor="#BB1C00">
		<tr><td colspan="2" align="center">HARCAMA KAYDETME PANELİ</td></tr>
		<tr>
			<td width="150">TARİH</td>
			<td width="150"><input type="date" name="tarih" value="<?=$tarih;?>" style="width: 150px;"></td>
		</tr>
		<tr><td>AÇIKLAMA</td><td><input type="text" name="acik" value=""></td></tr>
		<tr><td>FATURA</td><td><input type="text" name="belge" value=""></td></tr>	
		<tr><td>TUTAR</td><td><input type="text" name="tutar" value=""></td></tr>
		<tr><td>ÖDEME BELGESİ (Resim)</td><td><input type="file" name="dosya" value=""></td></tr>
		<tr><td colspan="2" align="center"><input type="submit" value="KAYDET" name="bt1"></td></tr>
	</table>
